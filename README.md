...
「北陸支援トラベラーズMap」は、観光を通じて北陸を支援したい人と、北陸の観光業に携わる人たちの架け橋になる、北陸地方各地域の交通情報や各種観光施設の「営業情報・サイトリンク・「X」(旧Twitter、以下「X」と表記)の発信情報・混雑率・レビュー」の情報をマップ上にマッピング・可視化させたマップ検索サービスです。
...
サービス概要にある通り、北陸地方の観光に関する情報に特化したマップ検索サービスで、トップ画面には北陸地方全体のマップが表示されており、マップ上には北陸地方各地域の交通情報や各種観光施設の「営業情報・サイトリンク・「X」の発信情報・混雑率・レビュー」の情報がマッピング・可視化されており、ユーザーはそれらの情報を参考にしながらマップ上や検索窓から気になる観光スポットや旅館を探す事が出来ます。
...
①後述の「過去2日以内に「X」で発信(ポスト)した観光施設」「レビューに「いいね」が多かった観光施設」の差別化されたピン留め表示で、サービスを使うユーザーに視覚的に分かりやすく訴求
②レコメンド機能で、可視化情報(各種施設のピン留め表示、交通・道路情報・施設や周辺エリアの混雑度など)も基にしつつ、敢えて「混雑度の低い施設及びその周辺のエリア」を優先的に表示させる事で、特定の観光施設やエリアへの観光客の集中を抑え、「いま来てほしい」と考えている北陸地方全ての観光施設の思いにできる限り答える
という、主に上記２つの手段を考えています。
...
■ MVPリリース時
・北陸地方全体のマップ表示
→マップ上に北陸地方各地域の「人や交通の流れ」の情報や各種観光施設の「営業情報・サイトリンク・「X」の発信情報・混雑率・レビュー」の情報をマッピング・可視化
可視化する情報↓
①マップ上に常に表示↓
・交通・道路情報→現在渋滞、混雑、交通規制がかかっている道や鉄道を色分けして表示
・下記のピン留め表示される施設及びその周辺のエリアの混雑度を色分けして表示
・以下の地点をマップ上にピン留め表示↓
その県及び地域の主要な観光施設
検索回数上位の観光施設
レビュー投稿・削除機能といいね機能実装後はレビューに「いいね」が多かった観光施設→
過去2日以内に「X」で発信(ポスト)した観光施設→
→上記２つのピン留め表示は他と違う表示にする事で差別化
・上記ピン留め表示について、「過去2日以内に「X」で発信(ポスト)した観光施設」「レビューに「いいね」が多かった観光施設」が「その県及び地域の主要な観光施設」や「検索回数上位の観光施設」であった場合、表示されるピンの種類は「過去2日以内に「X」で発信(ポスト)した観光施設」「レビューに「いいね」が多かった観光施設」に使われるピンを表示
...
■ WebAPI: 
・Google Maps Platform (地図・人や交通の流れ・交通及び道路情報・各種観光施設及びその周辺のエリアの営業情報や混雑度の情報・サイトリンクの表示及び取得)
・X API (「X」の発信情報を取得)
